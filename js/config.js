var config = {
  ...
  title: {
    ...
    es: 'Calles deseadas por peatones: Uso de un índice a nivel de calles para evaluar la transitabilidad en Bogotá'
  },
  subtitle: {
  ...
  images: [
    './resources/uniandes_150x.png',
    './resources/grupo-sur.png'
  ],
  byline: false,
  footer: false,
  chapters: [
    ...
    },
    {
      ...
      description: {
        ...
        es: 'Transitabilidad se define como la medida en que el entorno urbano es amigable para los peatones. En este caso, evaluamos la calidad de la red peatonal de la ciudad para comprender los factores que influyen en la transitabilidad, incluidos los componentes observables (p. ej., entorno construido) y los factores no observables (p. ej., percepciones) a niveles de meso y microescala y de acuerdo con las características de los peatones.'
      },
      location: {
    ...
    },
    {
      ...
      description: {
        ...
        es: 'En cuanto a los ancianos, los dispositivos de control de tráfico, buena iluminación, presencia de rampas y árboles, y poca congestión con pacificación del tráfico, son los atributos más importantes del entorno construido.'
      },
      location: {
        center: [-74.070074, 4.610067],
        zoom: 15,
    ...
    },
    {
      ...
      description: {
        ...
        es: 'Las personas de barrios populares prefieren la seguridad por encima de todo: valoran mucho la presencia de dispositivos de control de tráfico, así como cámaras policiales y de seguridad. También valoran la infraestructura adecuada en términos de inclusión, calidad y conectividad. La presencia de árboles y áreas comerciales también es importante.'
      } ,
      location: {
        center: [-74.070074, 4.610067],
        zoom: 15,
    ...
    },
    {
      ...
      image: false,
      description: {
        en: 'How is the quality of the pedestrian network in Bogotá?<br /><b>Navigate the map</b>',
        es: '¿Cómo es la calidad de la red peatonal en Bootá?<br /><b>Navega el mapa</b>'
      },
      location: {
        center: [-74.070074, 4.610067],
        zoom: 15,
    ...
    },
    {
      ...
      image: false,
      description: {
        en: 'How is the quality of the pedestrian network in Bogotá?<br /><a href="#">Navigate the map</a>',
        es: '¿Cómo es la calidad de la red de peatones en Bootá?<br /><a href="#">Navega el mapa</a>'
      },
      location: {
        center: [-74.070074, 4.610067],
        zoom: 14,
